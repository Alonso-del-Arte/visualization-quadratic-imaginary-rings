 ...
 * 
 * <ul>
 * <li>{@link com.alonsodelarte.quadraticRings.imaginaryquadraticinteger.AlgebraicInteger}, an interface for
 * defining algebraic integer classes.</li>
 * <li>{@link com.alonsodelarte.quadraticRings.imaginaryquadraticinteger.ImaginaryQuadraticRing}, defines objects
 * to represent imaginary quadratic integer rings.</li>
 * <li>{@link com.alonsodelarte.quadraticRings.imaginaryquadraticinteger.ImaginaryQuadraticInteger} is the main
 * class, defines objects representing imaginary quadratic integers.</li>
 * <li>{@link com.alonsodelarte.quadraticRings.imaginaryquadraticinteger.NumberTheoreticFunctionsCalculator} is a
 * collection of number theoretic functions, including basic primality testing 
 * and the Euclidean GCD algorithm.</li>
 * <li>{@link com.alonsodelarte.quadraticRings.imaginaryquadraticinteger.RingWindowDisplay} is a Swing component
 * in which to display diagrams of prime numbers in various quadratic integer 
 * rings.</li>
 * <li>{@link com.alonsodelarte.quadraticRings.imaginaryquadraticinteger.Exceptions.AlgebraicDegreeOverflowException}
 ...
 * <li>{@link com.alonsodelarte.quadraticRings.imaginaryquadraticinteger.Exceptions.NotDivisibleException} defines an
 ...
 * <li>{@link com.alonsodelarte.quadraticRings.imaginaryquadraticinteger.Exceptions.NonEuclideanDomainException} defines an
 ...
 * <li>{@link com.alonsodelarte.quadraticRings.imaginaryquadraticinteger.Exceptions.NonUniqueFactorizationDomainException}
 ...
 * <li>{@link com.alonsodelarte.quadraticRings.imaginaryquadraticinteger.Exceptions.UnsupportedNumberDomainException}
 * defines an exception to be thrown when an arithmetic operation results in an 
