 ...
 * com.alonsodelarte.quadraticRings.imaginaryquadraticinteger package.
 * 
 * <ul>
 * <li>{@link com.alonsodelarte.quadraticRings.fileops.FileChooserWithOverwriteGuard} extends
 * {@link javax.swing.JFileChooser} in order to prevent the user from 
 * accidentally overwriting an existing file.</li>
 * <li>{@link com.alonsodelarte.quadraticRings.fileops.JPEGFileFilter} filters out files that are not JPEG files
 * from a FileChooser dialog. This filter does not recognize *.jfif as a valid 
 * JPEG file extension.</li>
 * <li>{@link com.alonsodelarte.quadraticRings.fileops.PNGFileFilter} filters out files that are not PNG files
