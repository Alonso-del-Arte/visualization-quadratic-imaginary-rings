...
/**
 * Test of the main class, which defines objects that represent imaginary quadratic integers.
...
public class ImaginaryQuadraticIntegerTest {
     ...
     * Some of the values are pseudorandom numbers within given bounds.
     */
    @BeforeClass
    ...
    // Still working on the tests, so for now 17 tests pass, 2 fail and 2 are missing
     ...
     * For methods that return Strings, spaces are desirable but not required.
     * Therefore the tests should strip out spaces before asserting equality.
     * If the test of the toString method fails, the result of this test is irrelevant.
     */
    @Test
    ...
    /**
     * Test of toASCIIString method, of class ImaginaryQuadraticInteger.
     * For methods that return Strings, spaces are desirable but not required.
     * Therefore the tests should strip out spaces before asserting equality.
     */
    @Test
     ...
     * For methods that return Strings, spaces are desirable but not required.
     * Therefore the tests should strip out spaces before asserting equality.
     * If the test of the toASCIIString method fails, the result of this test is irrelevant.
     */
    @Test
